...
export const DEMO_ACCOUNTS: SeedAccount[] = [
  ...
  },
  {
    ...
    initials: 'KN',
    glyph: '$',
    blurb: 'Returns done right — graded at the door, rehomed nearby.',
  },
  {
    id: 'user_diya',
    kind: 'user',
    ...
    initials: 'DM',
    glyph: '$',
    blurb: 'Shop second-life finds close by and send back what didn’t fit.',
  },
  {
    id: 'user_ishaan',
    kind: 'user',
    ...
    initials: 'IG',
    glyph: '$',
    blurb: 'Give good gear a second run — return, resell, repeat.',
  },
  {
    id: 'user_priya',
    kind: 'user',
    ...
    initials: 'PR',
    glyph: '$',
    blurb: 'Keep it circular — return in-window, buy verified second-life.',
  },
  // --- Sellers -------------------------------------------------------------
  {
    id: 'seller_urban',
